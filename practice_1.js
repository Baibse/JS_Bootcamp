...
// console.log(circle.getArea().toFixed(2)) // 62.8
...
function startsWithSummer(text) {
    ...
    // let firstSixCharacter = text.slice(0, 6)
    // return firstSixCharacter === "Summer"
}
...
function closeToTen(a, b) {
    ...
    let distanceOfA = Math.abs(10 - a)
    let distanceOfB = Math.abs(10 - b)
...
//     let firstTwoCharacters = pattern.slice(0, 2)
//     let lastTwoCharacters = pattern.slice(2, 4)
//     return firstTwoCharacters + text + lastTwoCharacters
//  return pattern.slice(0, 2) + text + pattern.slice(2)
...
//    let firstWordSliced = first.slice(1)
//    let secondWordSliced = second.slice(1)
//    return firstWordSliced + secondWordSliced
...
// console.log(reverseArray([5, 11, 9])) // [9, 11, 5]
// console.log(reverseArray([7, 0, 0]))  // [0, 0, 7]
...
//         let isInRange = (i === 0 || i === 1 || i === arr.length - 1 || i === arr.lengt - 2)

//         if (currentNumber === 1 && nextNumber === 3 && isInRange)
//             return true
//     }
//     return false
// }
...
//         let hashTags = "#".repeat(rowIndex)
//         console.log(hashTags)
//     }
// }
// marioEasy(4)

// let someWord = "string".repeat(10)
...
function marioUpsideDown(height) {
